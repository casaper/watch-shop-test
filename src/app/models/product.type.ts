/**
 * Generated using quicktype cli:
 * ```sh
 * quicktype --lang ts --top-level Product --no-enums --prefer-types --prefer-unions --prefer-const-values --out src/app/models/product.type.ts src/assets/dummy-data/products.json
 * ```
...
const typeMap: any = {
  Product: o(
    [
      ...
      { json: 'medias', js: 'medias', typ: a(r('Media')) },
      {
        json: 'productDetails',
        js: 'productDetails',
        typ: r('ProductDetails'),
      },
      {
        json: 'productSpecifications',
        js: 'productSpecifications',
        typ: r('ProductDetails'),
      },
      { json: 'relatedProducts', js: 'relatedProducts', typ: a('') },
    ],
    false
  ),
  Media: o(
    [
      { json: 'targetAttr', js: 'targetAttr', typ: '' },
  ...
  Datum: o(
    [
      ...
      { json: 'iconTarget', js: 'iconTarget', typ: '' },
      { json: 'sortOrder', js: 'sortOrder', typ: 0 },
    ],
    false
  ),
